...
function renderTendResult() {
  ...
  // Data quality badge for progressive transparency
  ...
  if (qualityLabel) {
    descEl.innerHTML = descEl.textContent + ' <span style="font-size:11px;color:' + qualityColor + ';background:rgba(255,255,255,0.06);padding:2px 8px;border-radius:3px;margin-left:6px">' + qualityLabel + '</span>';
  }
